...
class EditAjax {	
	...
	public function change_upload_path($dir) {		
		...
		$upload_dir = realpath(\SCU\PATH.'shortcodes/'.$shortcode.'/resources/'.$resource_type);
	...
	public function file_remove() {
		...
		$file_path = realpath(\SCU\PATH.'shortcodes/'.$shortcode.'/resources/'.$resource_type.'/'.$file_name);
