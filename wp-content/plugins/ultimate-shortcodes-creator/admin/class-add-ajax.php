...
class AddAjax {	
	...
	public function add_create() {
		...
		$target_folder = wp_unique_filename($wp_filesystem->find_folder(\SCU\PATH.'shortcodes'), __('new', 'ultimate-shortcodes-creator'));
	...
	public function add_upload() {
		...
		$shortcodes_dir = wp_normalize_path(\SCU\PATH.'shortcodes/'.$file_name_unique);
