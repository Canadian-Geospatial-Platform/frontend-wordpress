...
class ShortCode {	
	...
	private function _initprops($shortcode) {
		...
		$this->shortcode_url =  esc_url( plugins_url( '/shortcodes/'.$shortcode, dirname(__FILE__) ) );
		$this->shortcode_path = realpath(dirname( __FILE__, 2).'/shortcodes/'.$shortcode).DIRECTORY_SEPARATOR;
