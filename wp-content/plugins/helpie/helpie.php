...
if (!defined('HELPIE_PLUGIN_VERSION')) {
    define('HELPIE_PLUGIN_VERSION', '1.9.3');
}
...
if (file_exists(plugin_dir_path(__FILE__) . "/includes/lib/freemius-integrator.php")) {
    require_once plugin_dir_path(__FILE__) . "/includes/lib/freemius-integrator.php";
    define('HELPIE_KB_VENDOR', 'freemius');
} else {
...
{
    load_plugin_textdomain('pauple-helpie', false, basename(dirname(__FILE__)) . '/languages');
}
