...
if (!class_exists('\Helpie\Includes\Actions\Term_Actions')) {
    ...
    class Term_Actions
    {
        ...
        public function remove_nonexistant_terms_from_dnd()
        {
            ...
            // error_log('csf_init - remove_nonexistant_terms_from_dnd');
            ...
            /* Remove non-existant terms from enabled */
            ...
            /* Remove non-existant terms from disabled */
            ...
            $options['helpie_mp_cats']['disabled'] = $disabled;
        ...
        public function check_missing_topics()
        {
            ...
            $terms = get_terms('helpdesk_category', ['hide_empty' => false, 'parent' => 0]);
