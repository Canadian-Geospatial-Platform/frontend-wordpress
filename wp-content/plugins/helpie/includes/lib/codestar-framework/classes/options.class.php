      ...
      echo '<div class="csf csf-options'. $theme . $class . $wrapper_class .'" data-slug="'. $this->args['menu_slug'] .'" data-unique="'. $this->unique .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo '<input type="submit" name="'. $this->unique .'[_nonce][save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Save', 'pauple-helpie' ) .'" data-save="'. esc_html__( 'Saving...', 'pauple-helpie' ) .'">';
            echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Reset Section', 'pauple-helpie' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset this section options?', 'pauple-helpie' ) .'">' : '';
            echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'pauple-helpie' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset all options?', 'pauple-helpie' ) .'">' : '';
            echo '</div>';
        ...
        if( ! empty( $this->args['show_footer'] ) ) {
          ...
          echo '<div class="csf-buttons">';
          echo '<input type="submit" name="csf_transient[save]" class="button button-primary csf-save'. $ajax_class .'" value="'. esc_html__( 'Save', 'pauple-helpie' ) .'" data-save="'. esc_html__( 'Saving...', 'pauple-helpie' ) .'">';
          echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="csf_transient[reset_section]" class="button button-secondary csf-reset-section csf-confirm" value="'. esc_html__( 'Reset Section', 'pauple-helpie' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset this section options?', 'pauple-helpie' ) .'">' : '';
          echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="csf_transient[reset]" class="button button-secondary csf-warning-primary csf-reset-all csf-confirm" value="'. esc_html__( 'Reset All', 'pauple-helpie' ) .'" data-confirm="'. esc_html__( 'Are you sure to reset all options?', 'pauple-helpie' ) .'">' : '';
          echo '</div>';
